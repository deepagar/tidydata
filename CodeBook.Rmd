...
Read README.md for description of original experiment.
...
The variables that were extracted from the original data are: 
...
The complete list of variables in the final tidy data are:
1. subject
2. activity
3. tBodyAcc-mean()-X
4. tBodyAcc-mean()-Y
